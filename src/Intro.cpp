...
void Intro::Start()
{
	...
	headingFont = io.Fonts->AddFontFromFileTTF("../assets/fonts/lemon_milk/LEMONMILK-Bold.otf", 52.0f);
	descriptionFont = io.Fonts->AddFontFromFileTTF("../assets/fonts/Inria_Sans/InriaSans-Regular.ttf", 24.0f);
